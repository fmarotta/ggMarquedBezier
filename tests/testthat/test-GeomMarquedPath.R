...
# NOTE: For some reason, on my laptop the labels are not printed in the
# vdiffr snapshot (they work fine when I inspect the plot interactively).
# However, the labels do show up in the tests from the GitHub action. For
# now, I've copied the plots generated by GHA into the _snaps directory, so
# bear in mind that local tests may fail for this reason.
